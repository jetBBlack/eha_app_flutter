...
class _BuildCodePageState extends State<BuildCodePage> {
  ...
  void initState() {
    ...
    super.initState();
    _codeCtl = TextEditingController(text: codeProvider.sercurityCode);
  }

  @override
  Widget build(BuildContext context) {
    final codeProvider = Provider.of<EmployerMomProvider>(context);
    return Padding(
      padding:
        ...
        child: Column(
          children: [
            ...
            Form(
              child: TextFormField(
                controller: _codeCtl,
                onChanged: codeProvider.setSecurityCode,
